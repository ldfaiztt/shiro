...
<link rel="stylesheet"
	href="<%=request.getContextPath()%>/resources/imooc/css/main.css"
	type="text/css" />
<script type="text/javascript"
	src="<%=request.getContextPath()%>/resources/script/jquery-1.9.0.min.js"></script>

</head>
<script>
jQuery(function($){
	var urlStr = "<%=request.getContextPath()%>/courses/view3/${courseId}";
