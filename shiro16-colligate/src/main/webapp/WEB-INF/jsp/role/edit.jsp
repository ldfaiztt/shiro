...
<%@taglib prefix="star45fn" uri="http://github.com/star45/tags/star45-functions" %>
<html>
<head>
    <title></title>
...
<body>
    ...
    <form:form method="post" commandName="role">
        ...
        <div class="form-group">
            ...
            <input type="text" id="resourceName" name="resourceName" value="${star45fn:resourceNames(role.resourceIds)}" readonly>
    ...
    <script>
        $(function () {
            ...
            var zNodes =[
                ...
                { id:${r.id}, pId:${r.parentId}, name:"${r.name}", checked:${star45fn:in(role.resourceIds, r.id)}},
                </c:if>
                </c:forEach>
            ];
